/**
 * SvelteKit BFF proxy for /api/oracles
 *
 * Forwards to the Fastify catalogue endpoint (no auth required — oracle
...
export const GET: RequestHandler = async ({ request }) => {
	const upstream = await fetch(`${INTERNAL_API_URL}/api/v1/catalogue/oracles`, {
		headers: {
