/**
 * SvelteKit BFF proxy for /api/catalogue/foes
 *
 * Forwards to the Fastify catalogue endpoint (no auth required — foe
...
export const GET: RequestHandler = async ({ request }) => {
	const upstream = await fetch(`${INTERNAL_API_URL}/api/v1/catalogue/foes`, {
		headers: {
