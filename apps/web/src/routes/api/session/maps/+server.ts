/**
 * SvelteKit BFF proxy for /api/session/maps
 *
 * GET  → Fastify GET  /api/v1/session/maps          (list)
 * POST → Fastify POST /api/v1/session/maps          (create)
 */
...
export const GET: RequestHandler = async ({ locals }) => {
	const res = await fetch(`${INTERNAL_API_URL}/api/v1/session/maps`, {
