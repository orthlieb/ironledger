		...
		{#if !compact}
			<span class="error-bar-icon" aria-hidden="true">
				...
				{:else}
					...
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
						<path
							d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zm0-384c13.3 0 24 10.7 24 24l0 112c0 13.3-10.7 24-24 24s-24-10.7-24-24l0-112c0-13.3 10.7-24 24-24zm-32 224a32 32 0 1 1 64 0 32 32 0 1 1 -64 0z"
						/>
					</svg>
				{/if}
			</span>
...
<style>
	...
	.error-bar--notification {
		--eb-color: var(--color-momentum);
	}
	.error-bar--warning {
		--eb-color: var(--color-wits);
	}
