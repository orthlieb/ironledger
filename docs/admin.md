...
- **Initial admin:** created by `npm run seed --workspace=apps/api`. Default credentials are listed in the README's _Dev Credentials_ table — change them on any deployed environment.
