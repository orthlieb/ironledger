...
This document describes the JSON data formats used by Iron Ledger for Ironsworn and Delve **catalogue/content** data (moves, assets, oracles, foes, delve tables). All data lives under `apps/api/data/` and is served to the web app on demand via the API's catalogue endpoints.
