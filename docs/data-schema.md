...
Yrt adds Touched assets and ritual cantrips — see [yrt/data-format-yrt.md](yrt/data-format-yrt.md#touched-assets).
...
Yrt adds additional oracle tables with structured values — see [yrt/data-format-yrt.md](yrt/data-format-yrt.md#yrt-oracles).
