...
> data-driven titles landed and predates the naming passes; the catalogue now ships the official Lodestar
> `Category: Name` titles (e.g. `Settlement: Name`, `Combat: Tactic`,
> `Character: Name (Elf)`),
